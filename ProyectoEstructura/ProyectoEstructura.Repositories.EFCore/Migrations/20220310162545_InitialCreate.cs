        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CostumerId = table.Column<string>(type: "nchar(5)", fixedLength: true, maxLength: 5, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "RACS", "RAUL CUDRIS SINNING" },
                    { "FNR", "FREDDY NAVARRO RODRIGUEZ" },
                    { "JCBJ", "JOSE BARRIOS JIMENEZ" }
                });
